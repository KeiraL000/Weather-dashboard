...
var apiKey = "8875d59bad26a38f30dcce2746d670e4";
...
function currentForeCast(city) {
    ...
    .then(function (data) {
        ...
        var uvURL = "https://api.openweathermap.org/data/2.5/uvi/forecast?&units=imperial&appid=" + apiKey + "&q=&lat=" + latitude + "&lon=" + longitude;
